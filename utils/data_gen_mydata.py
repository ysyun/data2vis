...
source_directory = "mydata/examples"
data_split_params = [{"tag": "train","percentage":[0,0.8]},{"tag": "dev","percentage":[0.8,0.9]},{"tag": "test","percentage":[0.9,1]}]
output_directory = "mydata/sourcedata"
data_utils_mydata.generate_data_pairs(
    source_directory, output_directory, data_split_params)
